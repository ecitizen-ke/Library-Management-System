...
class Library:
    ...
    def save_library_to_file(self, filename):
        ...
        with open(filename, "w") as filename:
         json.dump([vars(book) for book in self.books], filename) #Saves the library data (book details) to a JSON file 
        print("Library data saved successfully.")
        
    def load_library_from_file(self, filename):
        with open(filename, "r") as file:
            data = json.load(file) #Saves the library data (book details) to a JSON file 
